...
RUN git clone https://github.com/axibase/jmeter-xml-to-jmx-converter.git -b jdbc_1.4.1 \
...
RUN ant download_jars \
 && ant install \
 && wget -qO /opt/axibase/jmeter/lib/atsd-jdbc-1.4.7-DEPS.jar https://github.com/axibase/atsd-jdbc/releases/download/RELEASE-1.4.7/atsd-jdbc-1.4.7-DEPS.jar

#COPY atsd-jdbc-1.4.7-SNAPSHOT-DEPS.jar /opt/axibase/jmeter/lib/
